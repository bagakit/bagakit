"""Export a feature into OpenSpec change structure."""
...
def main() -> int:
    p = argparse.ArgumentParser(description="Export feature to OpenSpec change directory")
    p.add_argument("--root", default=".")
    p.add_argument("--feature", dest="feat", required=True)
