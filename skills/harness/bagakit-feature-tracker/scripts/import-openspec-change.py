"""Import an OpenSpec change into .bagakit/feature-tracker feature format."""
...
HARNESS_PATH = Path(__file__).resolve().with_name("feature-tracker.py")
...
def main() -> int:
    p = argparse.ArgumentParser(description="Import OpenSpec change to feature-tracker")
    p.add_argument("--root", default=".")
    p.add_argument("--change", required=True)
    p.add_argument("--feature-id", dest="feat_id", default="")
    args = p.parse_args()
