...
| `references/review/QA_HARD_METRICS.md` | 进入共享文档、对外分享、长期沉淀前 | 判定文章命题是否成立 |
| `references/review/LONGFORM_RUBRIC.md` | 博客、公开技术文章、内部专题长文终稿 | 早期研究或基础重建阶段 |
...
| `references/writing/STRUCTURE_PYRAMID.md` | 层级、段落推进与可读性 |
...
| `references/workflow/REWRITE_FEEDBACK_LOOP.md` | 把局部改写反馈抽象成可复用规则 |
...
| `writing_core_route_tools.py` | 低成本做 foundation check，并把 handoff 自动压成 route state |
