...
- Do: Inspect and upgrade the Goal surface to bagakit.goal.v.0.2, bind continuation-bearing owner receipts when present, run fresh-check before bounded execution, resolve semantic conflicts through Grill, and render Driver feedback from reconciled evidence.
